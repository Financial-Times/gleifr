...
test_that("we can parse unix_timestamps",{
	expect_equal(parse_lei_unix_ts("980985600000"), as.POSIXct("2001-02-01 00:00:00"))
	expect_equal(parse_lei_unix_ts("52534800000"), as.POSIXct("1971-09-01 02:00:00"))
	expect_equal(parse_lei_unix_ts("1514764800000"), as.POSIXct("2018-01-01 00:00:00"))
	expect_equal(parse_lei_unix_ts("1498089600000"), as.POSIXct("2017-06-22 01:00:00"))
})
...
test_that("we can parse lei iso8601", {
	expect_equal(class(parse_lei_iso8601_ts("2017-10-31T00:00:00.000+01:00"))[1], "POSIXct")
	expect_equal(class(parse_lei_iso8601_ts("2016-09-01T00:00:00+02:00"))[1], "POSIXct")
	expect_equal(class(parse_lei_iso8601_ts("2017-01-01T00:00:00.000Z"))[1], "POSIXct")
})

test_that("we can parse lei timestamp data",{
	expect_equal(parse_lei_ts(c("980985600000","2017-10-31T00:00:00",NA,"1514764800000")),
							 as.POSIXct(c("2001-02-01 00:00:00","2017-10-31 00:00:00",NA,"2018-01-01 00:00:00")))
})
